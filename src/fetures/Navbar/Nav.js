                    ...
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      >
                        ...
                        <ShoppingCartIcon
                          ...
                          aria-hidden="true"
                        />
                        <span className="inline-flex items-center rounded-md bg-red-50 mb-3 -ml-1 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
                          3
                        </span>
                      </button>
                      </Link>
                  ...
                  <div className="flex items-center px-5">
                    ...
                    >
                      ...
                      <ShoppingCartIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className=" inline-flex items-center rounded-md  mb-3 -ml-1 bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
                        2
                      </span>
                    </button>
                    </Link>
